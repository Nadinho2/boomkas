...
const TOOL_ROWS: ToolRow[] = [
  ...
  },
  {
    ...
    pricing: "Free • Core $20/mo • Pro $40/mo",
    autonomy: "High",
    categories: ["Coding Agents", "No-Code Builders"],
    features: ["WebContainers", "In-browser Node.js", "npm + terminal", "One-click deploy"],
    rating: 4.4,
  ...
  },
  {
    ...
    autonomy: "High",
    categories: ["Coding Agents", "No-Code Builders"],
    features: ["Cloud IDE", "DB + auth", "Hosting", "Integrations"],
    rating: 4.3,
  ...
  },
  {
    slug: "v0-vercel",
    name: "v0 by Vercel",
    bestFor: "Frontend developers and Next.js teams who want production-ready UI fast with one-click deploy",
    pricing: "Free tier • Pro (token-based)",
    autonomy: "Medium",
    categories: ["Coding Agents", "IDE Agents"],
    features: ["React + Tailwind", "shadcn/ui", "Vercel deploy", "Git integration"],
    rating: 4.2,
  ...
  },
  {
    ...
    pricing: "Free tier • $10/mo Individual • Business/Enterprise",
    autonomy: "High",
    categories: ["IDE Agents", "Coding Agents"],
    features: ["Agent Mode", "Workspace", "PR/Issues", "Actions integration"],
    rating: 4.3,
  ...
  },
  {
    slug: "gemini-cli",
    name: "Gemini CLI",
    bestFor: "Developers who want a free, terminal-first AI agent with massive context window and MCP support",
    pricing: "Free (open source)",
    autonomy: "Medium",
    categories: ["Coding Agents", "IDE Agents"],
    features: ["1M context", "MCP support", "ReAct loop", "Search grounding"],
    rating: 4.1,
  ...
  },
  {
    slug: "dify-ai",
    name: "Dify.ai",
    bestFor: "Teams building AI apps and multi-agent workflows with RAG, tool use, and API deployment",
    pricing: "Free self-hosted • Cloud from $59/mo",
    autonomy: "High",
    categories: ["Workflow Automation", "Multi-Agent"],
    features: ["Visual workflows", "RAG", "Agent nodes", "API publishing"],
    rating: 4.3,
  ...
  },
  {
    slug: "flowise",
    name: "Flowise",
    bestFor: "Developers who want a visual, self-hostable way to chain LLMs, tools, and memory into workflows",
    pricing: "Free open source • Cloud from $35/mo",
    autonomy: "Medium",
    categories: ["Multi-Agent", "Workflow Automation"],
    features: ["Visual builder", "LangChain", "Vector DB", "API deploy"],
    rating: 4.1,
  ...
  },
  {
    slug: "dust-tt",
    name: "Dust.tt",
    bestFor: "Teams that want fleets of specialized agents with shared knowledge bases and reusable skills",
    pricing: "Pro $29/user/mo • Business $69/user/mo",
    autonomy: "Medium",
    categories: ["Enterprise", "Multi-Agent"],
    features: ["Agent fleets", "Shared knowledge", "Discoverable skills", "Triggers"],
    rating: 4.1,
  ...
  },
  {
    slug: "sierra",
    name: "Sierra",
    bestFor: "Enterprises that want autonomous customer-facing agents with outcome-based accountability",
    pricing: "Outcome-based pricing",
    autonomy: "High",
    categories: ["Enterprise"],
    features: ["CX agents", "Brand voice", "Integrations", "Guardrails"],
    rating: 4.2,
  ...
  },
  {
    ...
    bestFor: "Large enterprises on ServiceNow who want agentic automation across ITSM, HR, and ops",
    pricing: "Enterprise add-on",
    autonomy: "High",
    categories: ["Enterprise", "Workflow Automation"],
    features: ["ITSM agents", "HR ops", "Governance", "Orchestration"],
    rating: 4.1,
  ...
  },
  {
    ...
    bestFor: "Enterprises building production AI agents on Google Cloud with Gemini models and RAG",
    pricing: "Usage-based (Google Cloud)",
    autonomy: "High",
    categories: ["Enterprise", "Multi-Agent"],
    features: ["Gemini models", "RAG grounding", "Connectors", "Evaluation"],
    rating: 4.2,
  ...
  },
  {
    slug: "coze",
    name: "Coze",
    bestFor: "Creators and developers building bots with plugins, workflows, memory, and multi-channel publishing",
    pricing: "Free tier • Pro varies",
    autonomy: "Medium",
    categories: ["Multi-Agent", "No-Code Builders"],
    features: ["Plugin marketplace", "Workflows", "Publishing", "Memory"],
    rating: 4.1,
